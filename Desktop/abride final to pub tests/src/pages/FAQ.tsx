    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: "سياسة الإلغاء المتكرر: إذا قمت (سائق أو راكب) بإلغاء الحجز 3 مرات خلال 15 يومًا، سيتم إيقاف حسابك تلقائيًا. لإعادة تفعيل الحساب، يجب التواصل مع فريق الدعم على +213 782 307 777 أو amineatazpro@gmail.com. هذه السياسة تضمن الالتزام والاحترام المتبادل بين جميع المستخدمين."
        },
        {
          q: "ماذا أفعل إذا واجهت مشكلة أثناء الرحلة؟",
          a: "اتصل بفريق الدعم فورًا على +213 782 307 777. نحن متواجدون 24/7 للمساعدة في حالات الطوارئ."
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: "يمكنك التواصل معنا عبر: الهاتف: +213 782 307 777، البريد الإلكتروني: amineatazpro@gmail.com، أو من خلال نموذج الاتصال في الموقع."
        }
      ]
    }
  ];
